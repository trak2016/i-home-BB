...
class SensorsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'ip_address' => ['type' => 'string', 'length' => 50, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_indexes' => [
            ...
            'device_id_2' => ['type' => 'index', 'columns' => ['device_id'], 'length' => []],
        ],
        '_constraints' => [
    ...
    public $records = [
        [
            ...
            'created' => '2016-01-02 17:29:22',
            'modified' => '2016-01-02 17:29:22'
        ],
    ];
}
